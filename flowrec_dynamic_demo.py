...
Uso:
  python flowrec_dynamic_demo.py

Genera:
  flowrec_t8_expansion.png
  flowrec_t9_monotonicity.png
  flowrec_t10_disruption.png
  flowrec_t11_epsilon.png
  flowrec_dynamic_summary.png  ← figura resumen completa
"""
...
# Verificar para las 3 primeras series base (índices finales del vector)
...
# Nodo que falla: tienda T05 (índice 8 en el grafo, cerca del centro del vector)
...
# =============================================================================
print("\n" + "─" * 60)
print("Generando figuras individuales...")
...
plt.tight_layout()
plt.savefig('flowrec_t8_expansion.png', dpi=140, bbox_inches='tight')
plt.close(fig1)
...
plt.tight_layout()
plt.savefig('flowrec_t9_monotonicity.png', dpi=140, bbox_inches='tight')
plt.close(fig2)
...
plt.tight_layout()
plt.savefig('flowrec_t10_disruption.png', dpi=140, bbox_inches='tight')
plt.close(fig3)
...
plt.tight_layout()
plt.savefig('flowrec_t11_epsilon.png', dpi=140, bbox_inches='tight')
plt.close(fig4)
...
# =============================================================================
# IMPRIMIR TABLA DE RESULTADOS FINALES
# =============================================================================
print("\n" + "=" * 60)
...
all_mono = all(r['es_monotono'] for r in t9_all) # Definir variable faltante
